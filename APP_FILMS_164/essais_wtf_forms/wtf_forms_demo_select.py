...
class MonPremierWTForm(FlaskForm):
    ...
    nom_genre_wtf = StringField("Clavioter le vehicule ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class DemoFormSelectWTF(FlaskForm):
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_genre = SubmitField("Choix vehicule")
