...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            imatriculation = %(value_date_genre_essai)s WHERE id_vehicule = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_annuler.data:
                return redirect(url_for("vehicule_afficher", order_by="ASC", id_vehicule_sel=0))
        ...
        if request.method == "GET":
            ...
            form_delete.nom_genre_delete_wtf.data = data_nom_genre["modele_vehicule"]
