...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Vehicule à ajouter", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateGenre(FlaskForm):
    ...
    date_genre_wtf_essai = StringField("Immatriculation", validators=[InputRequired("Immatriculation obligatoire"),
                                                               DataRequired("Immatriculation non valide")])
    submit = SubmitField("Modifier vehicule")
...
class FormWTFDeleteGenre(FlaskForm):
    ...
    """
    nom_genre_delete_wtf = StringField("Effacer ce vehicule")
    submit_btn_del = SubmitField("Effacer vehicule")
